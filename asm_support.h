...
// Taint: taint_offset in Array.
#define MIRROR_ARRAY_TAINT_OFFSET       (4 + MIRROR_OBJECT_HEADER_SIZE)
ADD_TEST_EQ(MIRROR_ARRAY_TAINT_OFFSET, art::mirror::Array::TaintOffset().Int32Value())
...
#define MIRROR_LONG_ARRAY_DATA_OFFSET (12 + MIRROR_OBJECT_HEADER_SIZE)
...
// Taint
#define MIRROR_STRING_TAINT_OFFSET (8 + MIRROR_OBJECT_HEADER_SIZE)
ADD_TEST_EQ(MIRROR_STRING_TAINT_OFFSET, art::mirror::String::TaintOffset().Int32Value())

// #define MIRROR_STRING_VALUE_OFFSET (8 + MIRROR_OBJECT_HEADER_SIZE)
#define MIRROR_STRING_VALUE_OFFSET (12 + MIRROR_OBJECT_HEADER_SIZE)
