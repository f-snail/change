...
enum InlineMethodOpcode : uint16_t {
  ...
  // Taint
  kIntrinsicTaintAddTaintInt,
  kIntrinsicTaintGetTaintInt,
  kIntrinsicTaintAddTaintShort,
  kIntrinsicTaintGetTaintShort,
  kIntrinsicTaintAddTaintBoolean,
  ...
  kIntrinsicTaintGetAllTaint,
  kIntrinsicTaintAddTaintFloat,
  kIntrinsicTaintGetTaintFloat,
  kIntrinsicTaintAddTaintDouble,
  kIntrinsicTaintGetTaintDouble,
  kIntrinsicTaintAddTaintIntArray,
  kIntrinsicTaintGetTaintIntArray,
  kIntrinsicTaintAddTaintByteArray,
  kIntrinsicTaintGetTaintByteArray,
  kIntrinsicTaintAddTaintShortArray,
  kIntrinsicTaintGetTaintShortArray,
  kIntrinsicTaintAddTaintBooleanArray,
  kIntrinsicTaintGetTaintBooleanArray,
  kIntrinsicTaintAddTaintCharArray,
